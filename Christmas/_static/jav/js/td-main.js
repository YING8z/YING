...
function DiemNgayYeu() {
   ...
   showngayyeu.innerHTML = "Are In Love: " + ngay + " days " + gio + " hours " + phut + " minutes " + giay + " seconds"
  }
  function DiemNguocNoel() {
    ...
    showdaynoel.innerHTML = "Countdown " + ngay + "Days Until Christmas";
}
  function StartMedia() {
