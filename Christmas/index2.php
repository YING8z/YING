...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/jpg" href="pt.png?<?=bin2hex(random_bytes(5));?>">
  ...
  <body>
    ...
    <div id="main">
      ...
      <div id="Container-Jav">
       ...
       YING <img class="girl-tick" src="./_static/img/banhradiem.webp?<?=bin2hex(random_bytes(5));?>">
          </div>
        </div>
        ...
        <div class="inner-glow-container">
          ...
          <div class="text-container">
     FA <img class="girl-tick" src="./_static/img/dutvodianh.webp?<?=bin2hex(random_bytes(5));?>">
          </div>
        </div>
      </div>
      <div id="ButtonContainer">
        <button id="PlayButton" onclick="StartMedia()">❄ Merry Christmas ❄</button>
      </div>
    </div>
    ...
    <audio src="chill.mp3" autoplay loop>
        </audio>
  </body>
</html>
