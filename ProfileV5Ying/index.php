...
<head>
    ...
    <meta property="og:image" content="bg3.webp">
    <title><?=$ThanhDieuHeader->title?></title>
    <!--/ @StyleSheets /-->
    <link rel="stylesheet" href="ws.theme.css">
    <link rel="stylesheet" href="animation.css">
    <link rel="stylesheet" href="index.css?v=<?php echo rand(1,999)?>">
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="custom-love.css">
    <!--/ @Frameworks /-->
    <link rel="stylesheet" href="jBox.all.min.css">
    <!--/ @CDN /-->
...
<body class="BodyStyle">
        ...
        <section class="td-content">
            <div class="about-me">
                ...
                <div class="avatar">
                    ...
                    <img class="crown" src="mong-vuot-rong.png">
            ...
            <section id="hr-mod">
                ...
                <a class="link-item <?= $network ?>" data-href="<?= $url ?>">
                    <div class="icon" style="background-image: url(webp/<?= $network ?>.webp)"></div>
                </a>
                <?php endforeach; ?>
            </section>
        </section>
            ...
            <div class="bg-img">
                <div class="middle animated">
                    <div class="img-male">
                        ...
                        <img class="crown-love" src="khung-4.png">
                            ...
                            <div class="simplebar-content">
                                <div class="nk-opt-set nk-opt-set-aside-apps change-bg">
                                    ...
                                    <div class="nk-opt-list col-4x">
                                        <div class="nk-opt-item active" data-bg="bg.gif">
                                            <span class="nk-opt-item-bg">
                                                <img src="bg.gif">
                                            </span>
                                            <span class="nk-opt-item-name">Default</span>
                                        </div>
                                        <div class="nk-opt-item" data-bg="anime-wall.jpg">
                                            <span class="nk-opt-item-bg">
                                                <img src="anime-wall.jpg">
                                            </span>
                                            <span class="nk-opt-item-name">Anime</span>
                                        </div>
                                        <div class="nk-opt-item" data-bg="bg3.webp">
                                            <span class="nk-opt-item-bg">
                                                <img src="bg3.webp">
                                            </span>
    ...
    <div class="running-cat">
        <img src="cat.webp" alt="Running Cat">
    </div>
    <span id="fps">
